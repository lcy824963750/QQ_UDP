...
public interface IMsgConstance {
	...
	byte command_leave = 0x35;	//用户主动下线通知
	byte command_msgUpdate = 0x36;	//信息更新消息
	byte command_msgUpdate_resp = 0x37;	//信息更新回应消息
	byte command_confirmPort = 0x38; //用于确认端口
	byte command_sendAddr = 0x39;	//发送地址消息
	byte command_sendPort = 0x40;	//发送群聊的端口
}
